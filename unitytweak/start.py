...
class Startpage ():
    ...
    def on_style_context_change(self, widget):
        self.main_bg_color = self.style_context.get_color(Gtk.StateFlags.ACTIVE)
        ...
        if appearance_symbolic_icon:
            appearance_symbolic_icon_pixbuf, was_sym = appearance_symbolic_icon.load_symbolic(self.main_bg_color, None, None, None)
        ...
        if unity_symbolic_icon:
            unity_symbolic_icon_pixbuf, was_sym = unity_symbolic_icon.load_symbolic(self.main_bg_color, None, None, None)
        ...
        if system_symbolic_icon:
            system_symbolic_icon_pixbuf, was_sym = system_symbolic_icon.load_symbolic(self.main_bg_color, None, None, None)
        ...
        if wm_symbolic_icon:
            wm_symbolic_icon_pixbuf, was_sym = wm_symbolic_icon.load_symbolic(self.main_bg_color, None, None, None)
